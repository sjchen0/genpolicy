...
def main(rep=1000):
    ...
    # parser.add_argument("--policy_path", default="../output/2025.12.28/011134/checkpoints-meta/checkpoint.pth", type=str)
    parser.add_argument("--policy_path", default="../output/2026.01.15/201051/checkpoints-meta/checkpoint.pth", type=str)
